    ...
    <script>
        ...
        async function createRegistration() {
            try {
                ...
                rep = await window.fetch('api?fn=processCreate' + getGetParams(), {
                    method: 'POST',
        ...
        function clearRegistration() {
            window.fetch('api?fn=clearRegistrations' + getGetParams(), {
                method: 'GET',
                cache: 'no-cache'
        ...
        function queryFidoMetaDataService() {
            window.fetch('api?fn=queryFidoMetaDataService' + getGetParams(), {
                method: 'GET',
                cache: 'no-cache'
            }).then(function(response) {
                return response.json();
    ...
    <div class="splitter">
        <div class="form">
            ...
            <div>
                ...
                <div>
                    <input type="checkbox" id="requireResidentKey" name="requireResidentKey" checked>
                ...
                <div style="margin-bottom:12px">
                    ...
                    <input type="text" id="userId" name="userId" value="01" required pattern="[0-9a-fA-F]{2,}">
                ...
                <div style="margin-bottom:12px">
                    ...
                    <input type="text" id="userName" name="userName" value="admin" required pattern="[0-9a-zA-Z]{2,}">
                ...
                <div style="margin-bottom:6px">
                    ...
                    <input type="text" id="userDisplayName" name="userDisplayName" value="admin" required>
                ...
                <details>
                    ...
                    <div>
                        <input type="radio" id="attestation_yes" value="no" name="attestation" onchange="setAttestation(this.value === 'yes')">
                        <label for="attestation_yes">yes</label>
                    </div>
                    <div>
                        <input type="radio" id="attestation_no" value="yes" name="attestation" onchange="setAttestation(this.value === 'yes')" checked>
